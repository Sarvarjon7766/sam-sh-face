					...
					<div className="bg-white rounded-lg border p-3 sm:p-4">
						<div className="flex flex-col sm:flex-row gap-3 sm:gap-4 flex-wrap">
							...
							<div className="flex flex-wrap gap-2 sm:gap-3 justify-end">
								{/* Bo'lim filteri */}
								<div className="flex items-center gap-2 bg-gray-100 px-3 py-2 rounded-lg border min-w-[150px] max-w-[200px] overflow-hidden">
								...
								{/* Holat filteri */}
								<div className="flex items-center gap-2 bg-gray-100 px-3 py-2 rounded-lg border min-w-[120px] max-w-[160px] overflow-hidden">
									<FaFilter className="text-gray-500 flex-shrink-0" size={14} />
									<select
										className="bg-transparent text-gray-800 border-none focus:outline-none focus:ring-0 text-sm w-full truncate"
								...
								<button
									...
									disabled={refreshing}
									className="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-lg flex items-center justify-center gap-2 text-sm transition-colors duration-200 font-medium min-w-[120px] max-w-[150px]"
									title="Yangilash"
								>
									{refreshing ? (
